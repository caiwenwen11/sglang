...
class TransferStatus:
    ...
    # PP ranks that have sent SWA / NSA / Mamba state pages (state is layer-
    # specific, each PP rank sends its portion). For non-PP / dsv4 models
    # this is a single-element set {0}.
